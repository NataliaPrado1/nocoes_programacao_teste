...
<html lang="ptbr">
    ...
    <body>
        ...
        <button onclick= "subtracao ()">-</button><button>0</button><button onclick= "igual()">=</button><button onclick= "divide ()">/</button><br>
